...
class LastWebhookResponse {
  ...
  @Field(() => String, {
    description: "Last webhook response status",
    nullable: true,
  })
  status?: string | null;

  @Field(() => String, {
    description: "Last webhook response message",
    nullable: true,
  })
  message?: string | null;
}
...
export class Webhook {
  ...
  @Field(() => String, { description: "Webhook name" })
  name!: string;
  ...
  @Field(() => String, { description: "Type of the webhook" })
  type!: string;
  ...
  @Field(() => String, {
    description: "Timestamp, which indicates when webhook was updated",
  })
  updated_at!: string;

  @Field(() => String, {
    description: "Timestamp, which indicates when webhook was created",
  })
  created_at!: string;

  @Field(() => String, { description: "Webhook url" })
  url!: string;

  @Field(() => String, { description: "Webhook test url" })
  test_url!: string;

  @Field(() => String, { description: "Webhook ping url" })
  ping_url!: string;
